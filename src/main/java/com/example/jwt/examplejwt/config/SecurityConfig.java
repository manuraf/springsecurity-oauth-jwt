...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   @Autowired  /** retrieve user details from the database  */
   ...
   /** SHA-256 is used to encode passwords. This is set in encodingStrength property */
   @Override
   ...
   /** enable the resource server to decode access tokens */
   @Bean
   ...
   /** needed by the authorization server */
   @Bean
